  ...
  function googleTagManager() {
    ...
    return {
      ...
      initialize: function initialize(_ref) {
        ...
        var containerId = config2.containerId, dataLayerName = config2.dataLayerName, customScriptSrc = config2.customScriptSrc, preview = config2.preview, auth = config2.auth, execution = config2.execution, nonce = config2.nonce;
        if (!containerId) {
