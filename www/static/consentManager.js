...
(function () {
   ...
   */
  function whenAvailable(objectPath, timeout = 3000) {
  ...
  // Expose utility functions on window.VectaraConsent
  window.VectaraConsent = {
    hasConsent: hasConsent,
    clearTrackingData: clearTrackingData,
    loadAnalytics: loadAnalytics,
    loadReodev: loadReodev,
    loadConsentedServices: loadConsentedServices,
